...
Sao chép dữ liệu JSON bên dưới vào tệp có tên **Orders.json**.
...
Tải dữ liệu mẫu vào bảng Đơn hàng bằng lệnh AWS CLI **batch-write-em**.

```bash
aws dynamodb batch-write-item --request-items file://Orders.json
```

Tải thành công sẽ tạo ra một thông báo tương tự như thông báo bên dưới.
